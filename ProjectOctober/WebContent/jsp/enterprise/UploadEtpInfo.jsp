...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<div class="row">
				<div class="col-xs-12">
					<s:form action="infoUploadAction" method="POST" enctype="multipart/form-data">
						<h3>업체 정보로 업로드할 파일을 선택해 주세요.</h3>
			...
			<div class="row">
				<div class="col-xs-12">
					<s:if test="uploaded != null">
						<p>사업자 번호 : <s:property value="etpNum"/> 님이 업로드 하신 업체 정보 사진 </p>
