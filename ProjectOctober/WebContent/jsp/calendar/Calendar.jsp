		...
		if(etpNumCheckSt == etpNumCheck){
			...
			var calendar = $('#calendar').fullCalendar({
				...
				select: function(start, end, jsEvent, view, allDay){	
					...
					$('body').on("change","#inputServiceList",function(){
...
<body>
	...
	<div>
		...
		<a href="takeEtp.action?etpNum=${#session.loginEtpNum}"><button class="btn btn-primary">사업자 메뉴로</button></a>
		<a href="${pageContext.request.contextPath}/highchart1.action?etpEmail=${#session.loginId}"><button class="btn btn-primary">통계</button></a>
	</div>
