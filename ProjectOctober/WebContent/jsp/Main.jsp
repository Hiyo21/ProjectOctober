 	...
 	<div class="row marketing">
				      		...
				      		<div class="container">								  
								  ...
								  <div id="seoul" class="collapse">								  
								 	...
								 	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=관악구"/>">관악구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=성북구"/>">성북구</a>
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=금천구"/>">금천구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=동작구"/>">동작구</a>	
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=마포구"/>">마포구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=서대문구"/>">서대문구</a><br>
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=강북구"/>">강북구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=노원구"/>">노원구</a>
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=은평구"/>">은평구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=은평구"/>">은평구</a>
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=성동구"/>">성동구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=부평구"/>">부평구</a>
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=양천구"/>">양천구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=중원구"/>">중원구</a>
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=용산구"/>">용산구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=도봉구"/>">도봉구</a><br>
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=광진구"/>">광진구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=강동구"/>">강동구</a>
								  ...
								  <div id="gyungido" class="collapse">
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=기흥구"/>">기흥구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=동안구"/>">동안구</a>
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=소사구"/>">소사구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=단원구"/>">단원구</a>
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=처인구"/>">처인구</a>&nbsp;<br><a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=단원구"/>">단원구</a>
								  ...
								  <div id="incheon" class="collapse">
								  	...
								  	<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=서구"/>">서구</a>&nbsp;<a href="<s:url value="/search/searchFreeKeyword.action?searchKeyword=동구"/>">동구</a>
		...
		<div class="mapImgD">
			...
			<map name="img_map_1" id="img_map_1">	
				<area shape="rect" coords="58,43,72,59" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=서울" alt="서울" />
				<area shape="rect" coords="37,45,57,62" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=인천" alt="인천" />
				<area shape="rect" coords="31,18,93,87" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=경기" alt="경기" />
				<area shape="rect" coords="95,4,192,85" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=강원" alt="강원" />
				<area shape="rect" coords="89,90,124,149" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=충북" alt="충북" />
				<area shape="rect" coords="21,92,72,147" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=충남" alt="충남" />
				<area shape="rect" coords="73,123,89,144" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=대전" alt="대전" />
				<area shape="rect" coords="31,150,102,194" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=전북" alt="전북" />
				<area shape="rect" coords="34,204,60,218" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=광주" alt="광주" />
				<area shape="rect" coords="17,195,97,256" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=전남" alt="전남" />
				<area shape="rect" coords="138,154,165,178" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=대구" alt="대구" />
				<area shape="rect" coords="126,87,205,164" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=경북" alt="경북" />
				<area shape="rect" coords="102,164,177,229" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=경남" alt="경남" />
				<area shape="rect" coords="178,169,205,196" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=울산" alt="울산" />
				<area shape="rect" coords="178,196,201,220" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=부산" alt="부산" />
				<area shape="rect" coords="10,270,54,289" href="/ProjectOctober/search/searchFreeKeyword.action?searchKeyword=제주" alt="제주" />
			</map>			
		</div>		
	</div>
