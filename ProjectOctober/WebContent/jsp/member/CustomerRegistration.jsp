...
<tr>
<th><span class="span">*</span><label for="email">이메일</label></th>
<td><input type="email" id="email" name="email" value="" size="10" class="inputText"></td>
<th><label for="zipcode">우편번호</label></th>
<td><input type="text" id="zipcode" name="zipcode" value="" size="10" class="inputText">&nbsp;&nbsp;<input type="button" value="검색"></td>
</tr>

<tr>
<th><span class="span">*</span><label for="password">P/W</label></th>
<td><input type="text" id="password" name="password" value="" size="10" class="inputText"></td>
<th><label for="address">주소</label></th>
<td><input type="text" id="address" name="address" value="" size="10" class="inputText"></td>
</tr>

<tr>
<th><span class="span">*</span><label for="password">P/W재확인</label></th>
<td><input type="text" id="password" name="password" value="" size="10" class="inputText"></td>
<th></th>
<td><input type="text" id="address" name="address" value="" size="10" class="inputText"></td>
</tr>
...
<tr>
<th><span class="span">*</span><label for="phone">전화번호</label></th>
<td>
<select name="hphone1" form="join_form" id="hphone1" class="MS_select MS_tel" >
<option value=''>선택</option>            <option value="02">서울 (02)</option>            <option value="031">경기 (031)</option>            <option value="032">인천 (032)</option>            <option value="033">강원 (033)</option>            <option value="041">충남 (041)</option>            <option value="042">대전 (042)</option>            <option value="043">충북 (043)</option>            <option value="044">세종 (044)</option>            <option value="051">부산 (051)</option>            <option value="052">울산 (052)</option>            <option value="053">대구 (053)</option>            <option value="054">경북 (054)</option>            <option value="055">경남 (055)</option>            <option value="061">전남 (061)</option>            <option value="062">광주 (062)</option>            <option value="063">전북 (063)</option>            <option value="064">제주 (064)</option>            <option value="0502">KT (0502)</option>            <option value="0503">온세텔레콤(0503)</option>            <option value="0504">온세텔레콤(0504)</option>            <option value="0505">Dacom (0505)</option>            <option value="070">인터넷전화 (070)</option>            <option value="080">착신 과금 서비스 (080)</option>
</select>
 - 
    <input type="text" name='hphone2' form="join_form" id="hphone2"  class="MS_input_tel" value="" size="4" maxlength="4" />
    -
    <input type="text" name="hphone3" form="join_form" id="hphone3"  class="MS_input_tel" value="" size="4" maxlength="4" />       
</td>
</tr>

<tr>
<th><span class="span">*</span><label for="gender">성별</label></th>
<td>
<input type="radio" name="gender" value="1"  class="MS_radio" />남 <input type="radio" name="gender" value="2" class="MS_radio" checked/>여      
</td>
</tr>
...
<b>회원약관</b><br><br>
<textarea cols=65 rows=16 style="border:1 solid eeeeee; width:600px; overflow-x:hidden; overflow-y:auto;">인터넷 쇼핑몰 『 앨리스리본』회원 약관 

제1조(목적)
이 약관은 앨리스리본 회사(전자상거래 사업자)가 운영하는 앨리스리본 사이버 몰(이하 "몰"이라 한다)에서 제공
...
제2조(정의)
①"몰" 이란 앨리스리본 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 앨리스리본 사이버몰의 초기 서비스화면(전면)
