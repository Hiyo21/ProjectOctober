...
<div class="container-fluid">
	<h1><b>자동화 설정</b></h1>
	<h4>선택 입력사항입니다</h4><br>
	<form role="form" action="finalizeRegistration" id="thirdForm" method="post">
		<div class="row">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<div class="col-xs-4" align="left"><a href="backToFirstRegistrationPage.action"><button type="button" class="btn btn-primary">이전</button></a></div>
		<div class="col-xs-4" align="center"><h3>3 / 3</h3></div>
		<div class="col-xs-4" align="right"><button type="button" class="btn btn-warning" onclick="return sendToAdmin();">관리자에게 전송</button></div>
		</div>
	</div>
